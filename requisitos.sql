-- 1 exemplo de exclusão de database

-- 1 exemplo de alteração de nome de tabela

-- 1 exemplo de exclusão de coluna

-- 1 exemplo de inclusão de coluna (a mesma coluna excluída pode ser recriada)

-- 1 exemplo de alteração da dados da tabela

-- 1 exemplo de exclusão de dados da tabela
